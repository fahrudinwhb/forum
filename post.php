...
<form class="adminrata" action="logout_admin.php">
	...
	<table border="1px" class="besar">
		...
		<?php 
			include 'koneksi.php';
			$query = "SELECT * FROM post WHERE status='ENABLE'";
			$result = mysql_query($query);
		...
		<tr class="kecilin">
			...
			<td><a  href="isi_update_post.php? id=<?php echo $row ['id_post']; ?>">
	...
	<a class="backTOPI" href="isi_delete_post.php? id=<?php echo $row ['id_post']; ?>">
